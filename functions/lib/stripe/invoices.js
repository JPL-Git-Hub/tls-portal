...
exports.getInvoicePaymentLink = exports.createClosingInvoice = void 0;
 ...
 */
exports.createClosingInvoice = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const invoiceData = {
            ...
            stripeCustomerId: sentInvoice.customer,
 ...
 */
exports.getInvoicePaymentLink = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError("unauthenticated", "User must be authenticated");
    }
